...
abstract class AbstractApi implements ApiInterface {
	 ...
	 * The client.
	 *
	 * @var \Required\Harvest\ClientInterface
	 */
	protected $client;
	 ...
	 * Constructor.
	 *
	 * @param \Required\Harvest\ClientInterface $client
	 */
	...
	public function allWithAutoPagingIterator( array $parameters = [] ): AutoPagingIterator {
		if ( ! method_exists( static::class, 'all' ) ) {
			throw new \Required\Harvest\Exception\BadMethodCallException( 'The resource does not support retrieving all objects.' );
		}
